...
class Secrets(Construct):
    def __init__(
        ...
        # Note: Using camelCase names to match Kubernetes secret format
        jwt_secrets = {
            "secret": self.jwt_secret.result,
            "anonKey": "GENERATED_BY_SUPABASE",  # Supabase will generate this using the secret
            "serviceKey": "GENERATED_BY_SUPABASE"  # Supabase will generate this using the secret
        }
        ManagedSecret(
            self, 
            "jwt_secret", 
